...
public:
    ...
    STDMETHOD_(int, Compare)(THIS_ const char* psz) SCONST OVERRIDE;

    /// @brief Compares the string with another string, ignoring case.
    /// @param psz The string to compare with.
    /// @return An integer less than, equal to, or greater than zero if the string is found, respectively, to be less than, to match, or be greater than psz.
    STDMETHOD_(int, CompareNoCase)(THIS_ const char* psz) SCONST OVERRIDE;
    ...
    STDMETHOD_(int, InsertChar)(THIS_ int nIndex, char ch) OVERRIDE;
    ...
    /// @return The new length of the string.
    STDMETHOD_(int, Insert)(THIS_ int nIndex, const char* psz) OVERRIDE;
    ...
    STDMETHOD_(int, ReplaceChar)(THIS_ char chOld, char chNew) OVERRIDE;
    ...
    STDMETHOD_(int, Replace)(THIS_ const char* pszOld, const char* pszNew) OVERRIDE;

    /// @brief Removes all occurrences of a character from the string.
    /// @param chRemove The character to remove.
    /// @return The number of characters removed.
    STDMETHOD_(int, Remove)(THIS_ char chRemove) OVERRIDE;
    ...
    STDMETHOD_(int, FindChar)(THIS_ char ch, int nStart DEF_VAL(0)) SCONST OVERRIDE;
    ...
    STDMETHOD_(int, ReverseFind)(THIS_ char ch) SCONST OVERRIDE;
    ...
    STDMETHOD_(int, Find)(THIS_ const char* pszSub, int nStart DEF_VAL(0)) SCONST OVERRIDE;

    /// @brief Retrieves a modifiable buffer for the string.
    /// @param nMinBufLength The minimum buffer length.
    /// @return A pointer to the buffer.
    STDMETHOD_(char*, GetBuffer)(THIS_ int nMinBufLength DEF_VAL(-1)) OVERRIDE;
    ...
    /// @param nNewLength The new length of the string.
    /// @return A pointer to the buffer.
    STDMETHOD_(char*, GetBufferSetLength)(THIS_ int nNewLength) OVERRIDE;
