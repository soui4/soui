...
#define MAX_MOVES	17		//最多一个棋只可能有17个走法
...
public:
	...
	//获得当前棋子可能的走法，车、炮最多可以产生19种走法
	//CHESSMAN chsmLayout[10][9]:布局数据
	//BOOL bTopRed:T-上部为红，下部为黑
	//POINT ptFocus:待移动棋子
	//POINT ptMoves[19]:可移动范围
	//BOOL *pbJiangJun:被将军标志
	//return:可能的走法数
