...
static const wchar_t *ksel_piece = L"sel_piece";     ///< select a piece animation
}
...
namespace Widgets{
    ...
    static const wchar_t *kbtn_prev = L"btn_prev";            ///< 上一局按钮部件名称
    static const wchar_t *kimg_dest_box = L"img_dest_box";   ///< 目的地提示框图片框部件名称
}
...
namespace Sounds{
    ...
    namespace Effects{
        ...
        static const wchar_t *kBegin = L"出征";                   ///< 出征音效
        static const wchar_t *kMove = L"走子";                   ///< 走子音效
        static const wchar_t *kEat = L"吃子";                  ///< 吃子音效
        static const wchar_t *kKilled = L"被吃";                ///< 被吃音效
        static const wchar_t *kBarback = L"进兵营";                ///< 进兵营音效
        static const wchar_t *kBomb = L"BOMB";                   ///< 炸弹音效
        static const wchar_t *kShowFlag = L"亮军棋";             ///< 亮军棋音效
    }
}
