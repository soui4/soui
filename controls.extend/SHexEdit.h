...
DEF_EVT_EXT(EventHexEditDataChanged, EVT_HE_DATACHANGED, { int fake; });
DEF_EVT_EXT(EventHexEditSelChanged, EVT_HE_SELCHANGED, {
    UINT m_nSelBegin;
    UINT m_nSelEnd;
});
...
class SHexEdit : public SPanel {
    ...
    const SByteArray &GetData() const
    {
        return m_xData;
    }
    ...
    void SetSelectedNoFocusCol(COLORREF tSelectedNoFocusBkgCol,
