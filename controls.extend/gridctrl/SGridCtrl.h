...
// Note: Specific inplace control classes are implemented using TplGridInplaceWnd template
// The template provides the common functionality while specific controls provide the UI
