...
int SListBoxEx::InsertItem(int iItem,SXmlNode xmlNode,LPARAM dwData/*=0*/)
{
...
UINT SListBoxEx::OnGetDlgCode() const
{
...
BOOL SListBoxEx::UpdateToolTip(CPoint pt, SwndToolTipInfo & tipInfo)
{
    if(m_iHoverItem==-1)
