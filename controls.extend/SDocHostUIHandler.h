...
struct IScriptCaller
{
    ...
    virtual void CallCPlusPlus(DWORD dispatchId,
...
class SJsCallCppIDispatch : public SUnknownImpl<IDispatch> {
  public:
    explicit SJsCallCppIDispatch(IScriptCaller *sc = NULL)
        : m_sc(sc)
    {
    }
...
class SDocHostUIHandler : public SUnknownImpl<IDocHostUIHandler> {
  public:
    ...
    {
        m_disContextMenu = disable;
    }
    void SetDisableF5(BOOL disable)
    {
        m_disF5 = disable;
    }
    void SetDisableScrollBar(BOOL bDisable)
    {
        m_bDisableScrollBar = bDisable;
    }
    void SetDisable3DBorder(BOOL bDisable)
    {
        m_bDisable3DBorder = bDisable;
    }
    void SetDisableTextSelect(BOOL bDisable)
    {
        m_bDisableTextSelect = bDisable;
    }
    COM_INTERFACE_BEGIN()
