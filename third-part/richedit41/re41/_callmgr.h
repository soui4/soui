...
private:
	...
	ULONG	_fTextChanged	:1;		//@cmember Text changed
	ULONG	_fChange		:1;		//@cmember Generic change
	ULONG	_fNewUndo		:1;		//@cmember New undo action added
	ULONG	_fNewRedo		:1;		//@cmember New redo action added
	ULONG	_fMaxText		:1;		//@cmember Max text length reached
	ULONG	_fSelChanged	:1;		//@cmember Selection changed
	ULONG	_fOutOfMemory	:1;		//@cmember Out of memory
	
	ULONG	_fInProtected	:1;		//@cmember if in EN_PROTECTED not.
};
