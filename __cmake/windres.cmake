...
elseif(IS_OHOS)
    ...
    if(SOUI_MINGW_WINDRES_EXE AND CMAKE_C_COMPILER)
        set(WINDRES_EXE "${SOUI_MINGW_WINDRES_EXE}")
        message(STATUS "OHOS resource tools: windres=${WINDRES_EXE}, cc=${CMAKE_C_COMPILER}")
        set(ENABLE_RESOURCES_BUILD ON)
        ...
        message(STATUS "OHOS MinGW windres not found. Resource files (.rc) will not be compiled.")
