...
macro(GIT_DEMOS ProName)
    ...
    if (NOT EXISTS ${DIRECORTY_CHECK})
        ...
        EXEC_PROGRAM("git" "${CMAKE_CURRENT_SOURCE_DIR}/demos" ARGS "clone https://github.com/soui4-demo/${ProName}.git")
    else()
...
if (DOWNLOAD_COMPILE_DEMOS)
    message("--- Download the demos in Soui4-demo")
    find_package(Git)
    if(Git_FOUND)
