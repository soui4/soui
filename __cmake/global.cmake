...
if (OUTPATH_WITHOUT_TYPE)
    ...
    if (CMAKE_CL_64)
        if("${CMAKE_GENERATOR_PLATFORM}" MATCHES "ARM64")
        message("---Put All generation in different Path(bin64a)")
        set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${PROJECT_SOURCE_DIR}/bin64a)
        set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${PROJECT_SOURCE_DIR}/bin64a)
        set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${PROJECT_SOURCE_DIR}/bin64a)
        else()
