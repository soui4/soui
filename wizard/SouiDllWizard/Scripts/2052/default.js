...
function AddConfig(proj, strProjectName) {
    try {
        ...
        CLTool.AdditionalIncludeDirectories = '"$(SOUI4PATH)\\config";"$(SOUI4PATH)\\components";"$(SOUI4PATH)\\SOUI\\include";"$(SOUI4PATH)\\utilities4\\include"';
        ...
        if (config_x64 != null) {
            ...
            CLTool_x64.AdditionalIncludeDirectories = '"$(SOUI4PATH)\\config";"$(SOUI4PATH)\\components";"$(SOUI4PATH)\\SOUI\\include";"$(SOUI4PATH)\\utilities4\\include"';
