...
namespace lua_tinker
{
...
#else
   template<>	HGDIOBJ				read(lua_State *L, int index);
#endif
...
#else
   template<>	void push(lua_State *L, HGDIOBJ ret);
#endif
   ...
   struct functor
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( T1, T2, T3, T4, T5 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ), read<T5> ( L, 5 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( T1, T2, T3, T4, T5 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ), read<T5> ( L, 5 ) ) ); return 1; }
   };

   template<typename RVal, typename T1, typename T2, typename T3, typename T4>
   struct functor < RVal, T1, T2, T3, T4 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( T1, T2, T3, T4 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( T1, T2, T3, T4 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ) ) ); return 1; }
   };

   template<typename RVal, typename T1, typename T2, typename T3>
   struct functor < RVal, T1, T2, T3 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( T1, T2, T3 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( T1, T2, T3 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ) ) ); return 1; }
   };

   template<typename RVal, typename T1, typename T2>
   struct functor < RVal, T1, T2 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( T1, T2 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( T1, T2 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ) ) ); return 1; }
   };

   template<typename RVal, typename T1>
   struct functor < RVal, T1 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( T1 )> ( L )( read<T1> ( L, 1 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( T1 )> ( L )( read<T1> ( L, 1 ) ) ); return 1; }
   };

   template<typename RVal>
   struct functor < RVal >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal ( *)( )> ( L )( ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, upvalue_<RVal (UAPI *)( )> ( L )( ) ); return 1; }
   };
   ...
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( T1, T2, T3, T4, T5 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ), read<T5> ( L, 5 ) ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( T1, T2, T3, T4, T5 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ), read<T5> ( L, 5 ) ); return 0; }
   };

   template<typename T1, typename T2, typename T3, typename T4>
   struct functor < void, T1, T2, T3, T4 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( T1, T2, T3, T4 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ) ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( T1, T2, T3, T4 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ), read<T4> ( L, 4 ) ); return 0; }
   };

   template<typename T1, typename T2, typename T3>
   struct functor < void, T1, T2, T3 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( T1, T2, T3 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ) ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( T1, T2, T3 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ), read<T3> ( L, 3 ) ); return 0; }
   };

   template<typename T1, typename T2>
   struct functor < void, T1, T2 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( T1, T2 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ) ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( T1, T2 )> ( L )( read<T1> ( L, 1 ), read<T2> ( L, 2 ) ); return 0; }
   };

   template<typename T1>
   struct functor < void, T1 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( T1 )> ( L )( read<T1> ( L, 1 ) ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( T1 )> ( L )( read<T1> ( L, 1 ) ); return 0; }
   };

   template<>
   struct functor < void >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);upvalue_<void ( *)( )> ( L )( ); return 0; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);upvalue_<void (UAPI *)( )> ( L )( ); return 0; }
   };
   ...
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);return upvalue_<int ( *)( lua_State*, T1 )> ( L )( L, read<T1> ( L, 1 ) ); }
	  static int invokeU ( lua_State *L ) {SaveState ss(L); return upvalue_<int (UAPI *)( lua_State*, T1 )> ( L )( L, read<T1> ( L, 1 ) ); }
   };

   template<>
   struct functor < int, lua_State* >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);return upvalue_<int ( *)( lua_State* )> ( L )( L ); }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);return upvalue_<int (UAPI *)( lua_State* )> ( L )( L ); }
   };
   ...
   struct mem_functor 
   {
	   static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8,T9,T10)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
	   ...
	   static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8,T9,T10)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
   ...
   {
	   static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8,T9)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
	   ...
	   static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8,T9)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
   ...
   {
	   static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
	   ...
	   static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 ,T6,T7,T8)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
   ...
   {
	   static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 ,T6,T7)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
	   ...
	   static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 ,T6,T7)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
   ...
   {
	   static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 ,T6)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
	   ...
	   static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 ,T6)> ( L ) )( 
		   read<T1> ( L, 2 ),
		   read<T2> ( L, 3 ), 
		   read<T3> ( L, 4 ), 
		   read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4, T5 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ), read<T5> ( L, 6 ) ) );; return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4, T5 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ), read<T5> ( L, 6 ) ) );; return 1; }
   };

   template<typename RVal, typename T, typename T1, typename T2, typename T3, typename T4>
   struct mem_functor < RVal, T, T1, T2, T3, T4 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3, T4 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3, T4 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ) ) ); return 1; }
   };

   template<typename RVal, typename T, typename T1, typename T2, typename T3>
   struct mem_functor < RVal, T, T1, T2, T3 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2, T3 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2, T3 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ) ) ); return 1; }
   };

   template<typename RVal, typename T, typename T1, typename T2>
   struct mem_functor < RVal, T, T1, T2 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1, T2 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1, T2 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ) ) ); return 1; }
   };

   template<typename RVal, typename T, typename T1>
   struct mem_functor < RVal, T, T1 >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( T1 )> ( L ) )( read<T1> ( L, 2 ) ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( T1 )> ( L ) )( read<T1> ( L, 2 ) ) ); return 1; }
   };

   template<typename RVal, typename T>
   struct mem_functor < RVal, T >
   {
      static int invoke ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal ( T::* )( )> ( L ) )( ) ); return 1; }
	  static int invokeU ( lua_State *L ) { SaveState ss(L); push ( L, ( read<T*> ( L, 1 )->*upvalue_<RVal (UAPI T::* )( )> ( L ) )( ) ); return 1; }
   };
   ...
   {
      static int invoke ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5,T6,T7,T8,T9,T10 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
      ...
      static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5,T6,T7,T8,T9,T10 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5,T6,T7,T8,T9 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
      ...
      static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5,T6,T7,T8,T9 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5,T6,T7,T8 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
      ...
      static int invokeU ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5,T6,T7,T8 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5,T6,T7 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
      ...
      static int invokeU ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5,T6,T7 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5,T6 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
      ...
      static int invokeU ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5,T6 )> ( L ) )( 
      read<T1> ( L, 2 ), 
      read<T2> ( L, 3 ), 
      read<T3> ( L, 4 ), 
      read<T4> ( L, 5 ), 
   ...
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4, T5 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ), read<T5> ( L, 6 ) ); return 0; }
	  static int invokeU ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4, T5 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ), read<T5> ( L, 6 ) ); return 0; }
   };

   template<typename T, typename T1, typename T2, typename T3, typename T4>
   struct mem_functor < void, T, T1, T2, T3, T4 >
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3, T4 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ) ); return 0; }
	  static int invokeU ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3, T4 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ), read<T4> ( L, 5 ) ); return 0; }
   };

   template<typename T, typename T1, typename T2, typename T3>
   struct mem_functor < void, T, T1, T2, T3 >
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2, T3 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ) ); return 0; }
	  static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2, T3 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ), read<T3> ( L, 4 ) ); return 0; }
   };

   template<typename T, typename T1, typename T2>
   struct mem_functor < void, T, T1, T2 >
   {
      static int invoke ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1, T2 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ) ); return 0; }
	  static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1, T2 )> ( L ) )( read<T1> ( L, 2 ), read<T2> ( L, 3 ) ); return 0; }
   };

   template<typename T, typename T1>
   struct mem_functor < void, T, T1 >
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( T1 )> ( L ) )( read<T1> ( L, 2 ) ); return 0; }
	  static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( T1 )> ( L ) )( read<T1> ( L, 2 ) ); return 0; }
   };

   template<typename T>
   struct mem_functor < void, T >
   {
      static int invoke ( lua_State *L )  { SaveState ss(L);( read<T*> ( L, 1 )->*upvalue_<void( T::* )( )> ( L ) )( ); return 0; }
	  static int invokeU ( lua_State *L )  {SaveState ss(L); ( read<T*> ( L, 1 )->*upvalue_<void(UAPI T::* )( )> ( L ) )( ); return 0; }
   };
   ...
   {
      static int invoke ( lua_State *L ) { SaveState ss(L);return ( read<T*> ( L, 1 )->*upvalue_<int( T::* )( lua_State*, T1 )> ( L ) )( L, read<T1> ( L, 2 ) ); }
	  static int invokeU ( lua_State *L ) {SaveState ss(L); return ( read<T*> ( L, 1 )->*upvalue_<int(UAPI T::* )( lua_State*, T1 )> ( L ) )( L, read<T1> ( L, 2 ) ); }
   };

   template<typename T>
   struct mem_functor < int, T, lua_State* >
   {
      static int invoke ( lua_State *L ) {SaveState ss(L); return ( read<T*> ( L, 1 )->*upvalue_<int( T::* )( lua_State* )> ( L ) )( L ); }
	  static int invokeU ( lua_State *L ) { SaveState ss(L);return ( read<T*> ( L, 1 )->*upvalue_<int(UAPI T::* )( lua_State* )> ( L ) )( L ); }
   };
...
//-------------------------------------
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T8>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T7,T8>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T8,T9>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T7,T8,T9>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T8,T9,T10>::invokeU, 1 );
   }
   ...
   {
	   ( void ) func;
	   lua_pushcclosure ( L, mem_functor<RVal, T, T1, T2, T3, T4, T5,T6,T7,T7,T8,T9,T10>::invokeU, 1 );
   }
