...
class CCRTAllocator {
  public:
    _Ret_maybenull_ _Post_writable_byte_size_(nBytes) _ATL_DECLSPEC_ALLOCATOR static void *Reallocate(_In_ void *p, _In_ size_t nBytes) throw()
    {
...
class ATL_NO_VTABLE CShellFileDialog : public CShellFileDialogImpl<CShellFileDialog> {
  ...
  public:
    CShellFileDialog(bool bSave, LPCWSTR lpszFileName = NULL, DWORD dwOptions = FOS_FORCEFILESYSTEM | FOS_PATHMUSTEXIST | FOS_FILEMUSTEXIST, LPCWSTR lpszDefExt = NULL, const COMDLG_FILTERSPEC *arrFilterSpec = NULL, UINT uFilterSpecCount = 0U)
    {
        HRESULT hRet = 0;
        if (bSave)
        {
...
class ATL_NO_VTABLE CShellFileOpenDialogImpl : public CShellFileDialogImpl<T> {
  public:
    ...
    CShellFileOpenDialogImpl(LPCWSTR lpszFileName = NULL, DWORD dwOptions = FOS_FORCEFILESYSTEM | FOS_PATHMUSTEXIST | FOS_FILEMUSTEXIST, LPCWSTR lpszDefExt = NULL, const COMDLG_FILTERSPEC *arrFilterSpec = NULL, UINT uFilterSpecCount = 0U)
    {
...
class CShellFileOpenDialog : public CShellFileOpenDialogImpl<CShellFileOpenDialog> {
  public:
    CShellFileOpenDialog(LPCWSTR lpszFileName = NULL, DWORD dwOptions = FOS_FORCEFILESYSTEM | FOS_PATHMUSTEXIST | FOS_FILEMUSTEXIST, LPCWSTR lpszDefExt = NULL, const COMDLG_FILTERSPEC *arrFilterSpec = NULL, UINT uFilterSpecCount = 0U)
        : CShellFileOpenDialogImpl<CShellFileOpenDialog>(lpszFileName, dwOptions, lpszDefExt, arrFilterSpec, uFilterSpecCount)
    {
    }
...
class ATL_NO_VTABLE CShellFileSaveDialogImpl : public CShellFileDialogImpl<T> {
  public:
    ...
    CShellFileSaveDialogImpl(LPCWSTR lpszFileName = NULL, DWORD dwOptions = FOS_FORCEFILESYSTEM | FOS_PATHMUSTEXIST | FOS_OVERWRITEPROMPT, LPCWSTR lpszDefExt = NULL, const COMDLG_FILTERSPEC *arrFilterSpec = NULL, UINT uFilterSpecCount = 0U)
    {
...
class CShellFileSaveDialog : public CShellFileSaveDialogImpl<CShellFileSaveDialog> {
  public:
    CShellFileSaveDialog(LPCWSTR lpszFileName = NULL, DWORD dwOptions = FOS_FORCEFILESYSTEM | FOS_PATHMUSTEXIST | FOS_OVERWRITEPROMPT, LPCWSTR lpszDefExt = NULL, const COMDLG_FILTERSPEC *arrFilterSpec = NULL, UINT uFilterSpecCount = 0U)
        : CShellFileSaveDialogImpl<CShellFileSaveDialog>(lpszFileName, dwOptions, lpszDefExt, arrFilterSpec, uFilterSpecCount)
    {
    }
...
class ATL_NO_VTABLE CFolderDialogImpl {
  public:
    ...
    CFolderDialogImpl(HWND hWndParent = NULL, LPCTSTR lpstrTitle = NULL, UINT uFlags = BIF_RETURNONLYFSDIRS)
        : m_lpstrInitialFolder(NULL)
        , m_pidlInitialSelection(NULL)
        , m_bExpandInitialSelection(false)
        , m_pidlSelected(NULL)
        , m_hWnd(NULL)
    {
    ...
    static int CALLBACK BrowseCallbackProc(HWND hWnd, UINT uMsg, LPARAM lParam, LPARAM lpData)
    {
        ...
        case BFFM_IUNKNOWN:
            ...
            break;
        default:
            // ATLTRACE2(atlTraceUI, 0, _T("Unknown message received in CFolderDialogImpl::BrowseCallbackProc@n"));
            break;
        }
...
class ATL_NO_VTABLE CRichEditFontDialogImpl : public CFontDialogImpl<T> {
  public:
    CRichEditFontDialogImpl(const CHARFORMAT &charformat, DWORD dwFlags = CF_SCREENFONTS, HDC hDCPrinter = NULL, HWND hWndParent = NULL)
...
class CRichEditFontDialog : public CRichEditFontDialogImpl<CRichEditFontDialog> {
  public:
    CRichEditFontDialog(const CHARFORMAT &charformat, DWORD dwFlags = CF_SCREENFONTS, HDC hDCPrinter = NULL, HWND hWndParent = NULL)
  ...
  public:
    ...
    static COLORREF *GetCustomColors()
    {
        static COLORREF rgbCustomColors[16] = {
            RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255), RGB(255, 255, 255),
        };
...
static inline HDC _AtlCreateDC(HGLOBAL hDevNames, HGLOBAL hDevMode)
{
    ...
    HDC hDC = ::CreateDC((LPCTSTR)lpDevNames + lpDevNames->wDriverOffset, (LPCTSTR)lpDevNames + lpDevNames->wDeviceOffset, (LPCTSTR)lpDevNames + lpDevNames->wOutputOffset, lpDevMode);
...
class CPrintDialog : public CPrintDialogImpl<CPrintDialog> {
  public:
    ...
    CPrintDialog(PRINTDLG &pdInit)
        : CPrintDialogImpl<CPrintDialog>(pdInit)
    {
    }
};
...
class ATL_NO_VTABLE CPrintDialogExImpl
  ...
  public:
    ...
    /** Constructor */
    CPrintDialogExImpl(DWORD dwFlags = PD_ALLPAGES | PD_USEDEVMODECOPIES | PD_NOPAGENUMS | PD_NOSELECTION | PD_NOCURRENTPAGE, HWND hWndParent = NULL)
    {
...
class CPrintDialogEx : public CPrintDialogExImpl<CPrintDialogEx> {
  public:
    CPrintDialogEx(DWORD dwFlags = PD_ALLPAGES | PD_USEDEVMODECOPIES | PD_NOPAGENUMS | PD_NOSELECTION | PD_NOCURRENTPAGE, HWND hWndParent = NULL)
...
class CMemDlgTemplateT {
  public:
    ...
    {
        Create(bDlgEx, lpszCaption, (short)rc.left, (short)rc.top, (short)(rc.right - rc.left), (short)(rc.bottom - rc.top), dwStyle, dwExStyle, lpstrFontName, wFontSize, wWeight, bItalic, bCharset, dwHelpID, ClassName.m_lpstr, Menu.m_lpstr);
    }
    ...
    {
        AddControl(ClassName.m_lpstr, wId, (short)rc.left, (short)rc.top, (short)(rc.right - rc.left), (short)(rc.bottom - rc.top), dwStyle, dwExStyle, Text.m_lpstr, pCreationData, nCreationData, dwHelpID);
    }
...
#define CONTROL_LTEXT(text, id, x, y, width, height, style, exStyle)         m_Template.AddStdControl(m_Template.CTRL_STATIC, (WORD)id, x, y, width, height, style | SS_LEFT | WS_GROUP, exStyle, text, NULL, 0);
#define CONTROL_CTEXT(text, id, x, y, width, height, style, exStyle)         m_Template.AddStdControl(m_Template.CTRL_STATIC, (WORD)id, x, y, width, height, style | SS_CENTER | WS_GROUP, exStyle, text, NULL, 0);
#define CONTROL_RTEXT(text, id, x, y, width, height, style, exStyle)         m_Template.AddStdControl(m_Template.CTRL_STATIC, (WORD)id, x, y, width, height, style | SS_RIGHT | WS_GROUP, exStyle, text, NULL, 0);
#define CONTROL_PUSHBUTTON(text, id, x, y, width, height, style, exStyle)    m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_PUSHBUTTON | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_DEFPUSHBUTTON(text, id, x, y, width, height, style, exStyle) m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_DEFPUSHBUTTON | WS_TABSTOP, exStyle, text, NULL, 0);
#ifndef _WIN32_WCE
#define CONTROL_PUSHBOX(text, id, x, y, width, height, style, exStyle) m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_PUSHBOX | WS_TABSTOP, exStyle, text, NULL, 0);
#endif /**< !_WIN32_WCE */
#define CONTROL_STATE3(text, id, x, y, width, height, style, exStyle)             m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_3STATE | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_AUTO3STATE(text, id, x, y, width, height, style, exStyle)         m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_AUTO3STATE | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_CHECKBOX(text, id, x, y, width, height, style, exStyle)           m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_CHECKBOX | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_AUTOCHECKBOX(text, id, x, y, width, height, style, exStyle)       m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_AUTOCHECKBOX | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_RADIOBUTTON(text, id, x, y, width, height, style, exStyle)        m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_RADIOBUTTON | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_AUTORADIOBUTTON(text, id, x, y, width, height, style, exStyle)    m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_AUTORADIOBUTTON | WS_TABSTOP, exStyle, text, NULL, 0);
#define CONTROL_COMBOBOX(id, x, y, width, height, style, exStyle)                 m_Template.AddStdControl(m_Template.CTRL_COMBOBOX, (WORD)id, x, y, width, height, style | CBS_DROPDOWN | WS_TABSTOP, exStyle, (LPCTSTR)NULL, NULL, 0);
#define CONTROL_EDITTEXT(id, x, y, width, height, style, exStyle)                 m_Template.AddStdControl(m_Template.CTRL_EDIT, (WORD)id, x, y, width, height, style | ES_LEFT | WS_BORDER | WS_TABSTOP, exStyle, (LPCTSTR)NULL, NULL, 0);
#define CONTROL_GROUPBOX(text, id, x, y, width, height, style, exStyle)           m_Template.AddStdControl(m_Template.CTRL_BUTTON, (WORD)id, x, y, width, height, style | BS_GROUPBOX, exStyle, text, NULL, 0);
#define CONTROL_LISTBOX(id, x, y, width, height, style, exStyle)                  m_Template.AddStdControl(m_Template.CTRL_LISTBOX, (WORD)id, x, y, width, height, style | LBS_NOTIFY | WS_BORDER, exStyle, (LPCTSTR)NULL, NULL, 0);
#define CONTROL_SCROLLBAR(id, x, y, width, height, style, exStyle)                m_Template.AddStdControl(m_Template.CTRL_SCROLLBAR, (WORD)id, x, y, width, height, style | SBS_HORZ, exStyle, (LPCTSTR)NULL, NULL, 0);
#define CONTROL_ICON(text, id, x, y, width, height, style, exStyle)               m_Template.AddStdControl(m_Template.CTRL_STATIC, (WORD)id, x, y, width, height, style | SS_ICON, exStyle, text, NULL, 0);
#define CONTROL_CONTROL(text, id, className, style, x, y, width, height, exStyle) m_Template.AddControl(className, (WORD)id, x, y, width, height, style, exStyle, text, NULL, 0);
    ...
    LRESULT OnCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL & /**< bHandled */)
{
    ...
    if (HIWORD(wParam) == BN_CLICKED && (LOWORD(wParam) == IDOK || LOWORD(wParam) == IDCANCEL) && ((m_psh.dwFlags & PSH_MODELESS) != 0) && (GetActivePage() == NULL))
        DestroyWindow();
    return lRet;
}
                    ...
                    for (WORD nItem = 0; nItem < nItems; nItem++)
                    {
                        ...
                        if (ATL::_DialogSplitHelper::IsActiveXControl(pItem, bDialogEx))
                        {
                            ...
                            if (SUCCEEDED(hr))
                            {
                                ATL::CAxWindow2 wnd;
                                // Get control caption.
                                LPWSTR pszClassName = bDialogEx ? (LPWSTR)(((ATL::_DialogSplitHelper::DLGITEMTEMPLATEEX *)pItem) + 1) : (LPWSTR)(pItem + 1);
                                // Get control rect.
                                RECT rect = { 0 };
                                ...
                                wnd.Create(m_hWnd, &rect, NULL, (bDialogEx ? ((ATL::_DialogSplitHelper::DLGITEMTEMPLATEEX *)pItem)->style : pItem->style) | WS_TABSTOP, bDialogEx ? ((ATL::_DialogSplitHelper::DLGITEMTEMPLATEEX *)pItem)->exStyle : 0, bDialogEx ? ((ATL::_DialogSplitHelper::DLGITEMTEMPLATEEX *)pItem)->id : pItem->id, NULL);
...
/** 195,24 */
/**
 * LTEXT           "Wizard Explanation\r@n(The height of the static text should be in multiples of 8 dlus)",
 */
...
class CWizard97SheetWindow : public CPropertySheetWindow {
  public:
    /** Constructors */
    CWizard97SheetWindow(HWND hWnd = NULL)
...
class CWizard97PageWindow : public CPropertyPageWindow {
  public:
    /** Constructors */
    CWizard97PageWindow(HWND hWnd = NULL)
...
class ATL_NO_VTABLE CWizard97PageImpl : public CPropertyPageImpl<T, TBase> {
  ...
  public:
    CWizard97PageImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL)
        : baseClass(title)
    {
    }
...
class ATL_NO_VTABLE CWizard97ExteriorPageImpl : public CPropertyPageImpl<T, TBase> {
  ...
  public:
    /** Constructors */
    CWizard97ExteriorPageImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL)
        : baseClass(title)
    {
        m_psp.dwFlags |= PSP_HASHELP;
...
class ATL_NO_VTABLE CWizard97InteriorPageImpl : public CPropertyPageImpl<T, TBase> {
  ...
  public:
    /** Constructors */
    CWizard97InteriorPageImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL)
        : baseClass(title)
    {
        m_psp.dwFlags |= PSP_HASHELP;
        m_psp.dwFlags &= ~PSP_HIDEHEADER;
...
class CAeroWizardFrameWindow : public CPropertySheetWindow {
  public:
    /** Constructors */
    CAeroWizardFrameWindow(HWND hWnd = NULL)
        : CPropertySheetWindow(hWnd)
    {
    }
...
class CAeroWizardPageWindow : public CPropertyPageWindow {
  public:
    /** Constructors */
    CAeroWizardPageWindow(HWND hWnd = NULL)
        : CPropertyPageWindow(hWnd)
    {
    }
...
inline int AtlTaskDialog(HWND hWndParent, ATL::_U_STRINGorID WindowTitle, ATL::_U_STRINGorID MainInstructionText, ATL::_U_STRINGorID ContentText, TASKDIALOG_COMMON_BUTTON_FLAGS dwCommonButtons = 0U, ATL::_U_STRINGorID Icon = (LPCTSTR)NULL)
{
    int nRet = -1;

#ifdef _WTL_TASKDIALOG_DIRECT
    USES_CONVERSION;
    HRESULT hRet = ::TaskDialog(hWndParent, ModuleHelper::GetResourceInstance(), IS_INTRESOURCE(WindowTitle.m_lpstr) ? (LPCWSTR)WindowTitle.m_lpstr : T2CW(WindowTitle.m_lpstr), IS_INTRESOURCE(MainInstructionText.m_lpstr) ? (LPCWSTR)MainInstructionText.m_lpstr : T2CW(MainInstructionText.m_lpstr), IS_INTRESOURCE(ContentText.m_lpstr) ? (LPCWSTR)ContentText.m_lpstr : T2CW(ContentText.m_lpstr), dwCommonButtons, IS_INTRESOURCE(Icon.m_lpstr) ? (LPCWSTR)Icon.m_lpstr : T2CW(Icon.m_lpstr), &nRet);
    ATLVERIFY(SUCCEEDED(hRet));
#else
...
class ATL_NO_VTABLE CTaskDialogImpl {
  public:
    ...
    /** Constructor */
    CTaskDialogImpl(HWND hWndParent = NULL)
        : m_hWnd(NULL)
    {
...
class CTaskDialog : public CTaskDialogImpl<CTaskDialog> {
  public:
    CTaskDialog(HWND hWndParent = NULL)
        : CTaskDialogImpl<CTaskDialog>(hWndParent)
    {
