...
DECLARE_INTERFACE_(IDropShadowImageFilter, IImageFilter)
{
     ...
     * @param sigmaX blur radius in horizontal direction
     * @param sigmaY blur radius in vertical direction
     * @param color color
...
DECLARE_INTERFACE_(IBlurImageFilter, IImageFilter)
{
    ...
    /**
     * @brief Get the initialization parameters of ImageEffect
     * @param sigmaX blur radius in horizontal direction
     * @param sigmaY blur radius in vertical direction
     * @param input input image
     */
...
DECLARE_INTERFACE_(IComposeImageFilter, IImageFilter)
{
    ...
    /**
     * @brief Initialize
     * @param outer outer image
     * @param inner inner image
     */
...
DECLARE_INTERFACE_(ITileImageFilter, IImageFilter)
{
    ...
    /**
     * @brief Get the initialization parameters of ImageEffect
     * @param srcRect source image region
     * @param dstRect destination image region
     * @param input input image
     */
