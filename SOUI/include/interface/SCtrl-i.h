...
DECLARE_INTERFACE_(IGridCell, IObjRef)
{
    ...
    STDMETHOD_(BOOL, OnSetCursor)(THIS) PURE;
};
...
DECLARE_INTERFACE_(IGridCtrl, ICtrl)
{
    ...
    // Refresh and redraw
    STDMETHOD_(BOOL, RedrawCell)(THIS_ int nRow, int nCol, IRenderTarget* pRT) PURE;
    STDMETHOD_(BOOL, RedrawCell2)(THIS_ const SCELLID cell, IRenderTarget* pRT) PURE;
