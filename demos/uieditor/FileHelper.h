...
*/    
static inline BOOL BuildFilePath(LPCTSTR pszCurPath,LPCTSTR pszNewPath,BOOL bPath=TRUE)
{
...
public:
    ...
    TCHAR m_szFileTitle[MAX_PATH];   // contains file title after return
    TCHAR m_szFileName[MAX_PATH];     // contains full path name after return
