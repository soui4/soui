...
typedef SNS::SApplication * (*funSouiInitApp)(AAssetManager* assetMgr, LPCSTR pszAssetDir);
typedef void (*funSouiUninitApp)(SNS::SApplication *pApp);
typedef int (*funSouiStartup)(long screenId,const char* pszLayout);
typedef void (*funSouiShutdown)(long screenId);
